...
Answer: Option 3. For Heap sort worst case and best case time complexity is of order n*log(n), whereas for bubble sort worst case time complexity is n^2 and best case is n. So, Heap sort will perform efficently for large input sizes.
